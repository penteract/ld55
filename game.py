...
class Demon():
    ...
    def __init__(self):
        ...
        # fight data
        # fight objects are pairs of linked lists of demons [[back0,front0],[back1,front1]]; the front and back of the line on each side of the fight.
        self.fight = None
    ...
    def remove(self):
        ...
        if self.next is not None:
            ...
            self.fight[self.side][1] = self.prev
